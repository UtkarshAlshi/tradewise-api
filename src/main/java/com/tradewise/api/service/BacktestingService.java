...
// // import com.tradewise.api.model.User; // User model is now in user-service
...
public class BacktestingService {
    ...
    // // private final UserService userService; // UserService is now in user-service

    // public BacktestingService(StrategyRepository strategyRepository,
    //                           MarketDataService marketDataService
    //                           /*, UserService userService*/) { // Removed UserService from constructor
    ...
    //     // User user = userService.findByEmail(userEmail); // User service is separate
    //     Strategy strategy = strategyRepository.findById(request.getStrategyId())
    //             .orElseThrow(() -> new RuntimeException("Strategy not found"));

    //     // --- CRITICAL SECURITY CHECK ---
    //     // This check will eventually be handled by the strategy-service or API Gateway
